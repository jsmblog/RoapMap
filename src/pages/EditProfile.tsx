...
const EditProfile: React.FC = () => {
  ...
  const [profileURL, setProfileURL] = useState<string>(currentUserData.photo);
  ...
  const handleConfirmUpload = async () => {
    ...
    try {
      ...
      const path = `posts/${
        currentUserData.uid
      }/profile_pictures/${generateUUID()}.${ext}`;
  ...
  const fieldConfigMap: Record<string, Partial<EditingObjectType>> = {
    ...
    gender: {
      ...
      options: [
        ...
        { label: t("nonBinary"), value: t("nonBinary")},
        { label: t("lgbtq"), value: t("lgbtq") },
        { label: t("preferNotToSay"), value: t("preferNotToSay") },
      ],
      name: "g",
    },
    birthdate: {
    ...
    password: {
      ...
      label: t("newPassword"),
      label2: t("confirmPassword"),
      placeholder: t("enterNewPassword"),
      placeholder2: t("confirmNewPassword"),
      type: "password",
      name: "pass",
    },
  };
    ...
    <IonPage>
      <IonHeader className="edit-profile-hearder">
        <IonToolbar className="edit-profile-toolbar tema-oscuro ">
          ...
          <IonTitle className="ion-title texto-quinto">
            {t("editProfile")}
          </IonTitle>
        </IonToolbar>
      </IonHeader>
          ...
          <div className="edit-profile-info-container tema-oscuro">
            ...
            >
              ...
              <span className="texto-secundario">
                {currentUserData.birth.split("T")[0]}
              </span>
              <IonIcon
                className="chevron-icon iconos-oscuros"
                slot="end"
